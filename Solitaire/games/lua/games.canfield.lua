...
local triple_canfield               = Copy(canfield)
...
local superior_canfield             = Copy(canfield)
...
local variegated_canfield           = Copy(double_canfield)
...
RegisterGame(eagle_wing)
RegisterGame(minerva)
RegisterGame(rainfall)
RegisterGame(superior_canfield)
RegisterGame(variegated_canfield)
