    ...
    , _sources {std::move(sources)}
{
    ...
    // menu
    {
        ...
        menuPanel.RelativeSize = {1.f, 0.05f};
    ...
    // status
    {
        ...
        statusPanel.RelativeSize = {1.f, 0.10f};
    ...
    , _sources {std::move(sources)}
{
    ...
    tabContainer.RelativeSize = {0.85f, 1.f};
...
void form_menu::create_game_lists(dock_layout& panelLayout)
{
    ...
    panelFilter.RelativeSize = {1.f, 0.05f};
    ...
    tabGames.RelativeSize = {0.5f, 1.f};
...
void form_menu::create_game_details(dock_layout& panelLayout)
{
    ...
    panelGameDetails.RelativeSize = {0.5f, 1.f};
...
void form_menu::create_section_cardset(tab_container& parent)
{
    ...
    lbxCardsets.RelativeSize = {0.5f, 0.25f};
    ...
    panelCards.RelativeSize = {1.f, 0.75f};
    panelCards.ZOrder       = 1;
    ...
    auto const cardsetChanged {[this, &lbxCardsets, &panelCards](auto const& val) {
        ...
        for (u8 s {static_cast<u8>(suit::Hearts)}; s <= static_cast<u8>(suit::Spades); ++s) {
            for (u8 r {static_cast<u8>(rank::Ace)}; r <= static_cast<u8>(rank::King); ++r) {
                ...
                imgBox.Alignment = {.Horizontal = gfx::horizontal_alignment::Center, .Vertical = gfx::vertical_alignment::Middle};
            }
        }
    }};
