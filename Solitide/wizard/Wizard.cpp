    ...
    : form {{"Wizard", window.bounds()}}
{
...

    {
        ...
        spnDecks.RelativeSize = {.Width = 30_pct, .Height = 100_pct};
        spnDecks.Min          = 1;
        spnDecks.Max          = 4;
        spnDecks.Step         = 1;
        spnDecks.Value        = 1;
...

    {
        auto const createPileSize {[&](auto&& layout, std::string const& name) {
            ...
            spn.RelativeSize = {30_pct, 100_pct};
            spn.Min          = 0;
            spn.Max          = 20;
            spn.Step         = 1;
            spn.Value        = 0;
        ...
        size_i const boxSize {2, 12};
        {
            ...
            spnRedeals.RelativeSize = {.Width = 30_pct, .Height = 100_pct};
            spnRedeals.Min          = -1;
            spnRedeals.Max          = 5;
            spnRedeals.Step         = 1;
            spnRedeals.Value        = 1;
    ...
    _lbxLog->HoveredItemIndex.Changed.connect([this] {
        _lbxLog->HoveredItemIndex = -1;
    });
