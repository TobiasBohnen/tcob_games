...
local base = {
    ...
    None = function()
        return {
            Hint = { "None" },
            Func = function(_, _, _) return false end
        }
    end,
    Any = function()
        return {
...
return {
    ...
    ace_uprank_top = { Base = base.Ace(), Build = build.UpByRank(), Move = move.Top() },
    ...
    any_downcolor_inseqsuit = { Base = base.Any(), Build = build.DownInColor(), Move = move.InSeqInSuit() },
    ...
    none_downac_inseq = { Base = base.None(), Build = build.DownAlternateColors(), Move = move.InSeq() },
    ...
    ff_upsuit_top = { Base = base.FirstFoundation(), Build = build.UpInSuit(true), Move = move.Top() },
    ff_upsuit_none = { Base = base.FirstFoundation(), Build = build.UpInSuit(true), Move = move.None() },
