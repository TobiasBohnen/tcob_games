...
return {
    ...
    ace_uprank_none_l13 = { Base = base.Ace(), Build = build.UpByRank(), Move = move.None() },
    ace_upsuit_top = { Base = base.Ace(), Build = build.UpInSuit(), Move = move.Top() },
    ace_upsuit_top_l13 = { Base = base.Ace(), Build = build.UpInSuit(), Move = move.Top(), Limit = 13 },
    ...
    king_downrank_none_l13 = { Base = base.King(), Build = build.DownByRank(), Move = move.None(), Limit = 13 },
    king_downsuit_top = { Base = base.King(), Build = build.DownInSuit(), Move = move.Top() },
    king_downsuit_top_l13 = { Base = base.King(), Build = build.DownInSuit(), Move = move.Top(), Limit = 13 },
